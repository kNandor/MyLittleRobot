#ifndef MPU6050DRIVER_HEADER
#define MPU6050DRIVER_HEADER
...
public:
  ...
  void init(uint8_t accel_Range=0,uint8_t gyro_Range=0){
    write_reg (MPU6050_PWR_MGMT_1, 0);
    switch (accel_Range) {
      case 1:
        write_reg (MPU6050_ACCEL_CONFIG,MPU6050_FS_SEL_1);
        accel_scale=8192;
        break;
      case 2:
        write_reg (MPU6050_ACCEL_CONFIG,MPU6050_FS_SEL_2);
        accel_scale=4096;
        break;
      case 3:
        write_reg (MPU6050_ACCEL_CONFIG,MPU6050_FS_SEL_3);
        accel_scale=2048;
        break;
      default:
        write_reg (MPU6050_ACCEL_CONFIG,MPU6050_FS_SEL_0);
        accel_scale=16384;
    }

    switch (gyro_Range) {
      case 1:
        write_reg(MPU6050_GYRO_CONFIG,MPU6050_FS_SEL_1);
        gyro_scale=65.5;
        break;
      case 2:
        write_reg(MPU6050_GYRO_CONFIG,MPU6050_FS_SEL_2);
        gyro_scale=32.8;
        break;
      case 3:
        write_reg(MPU6050_GYRO_CONFIG,MPU6050_FS_SEL_3);
        gyro_scale=16.4;
        break;
      default:
        write_reg(MPU6050_GYRO_CONFIG,MPU6050_FS_SEL_0);
        gyro_scale=131;
    }
  }

  // int init();
  MPU6050_DATA readValue();
  int read(int start, uint8_t *buffer, int size);
private:
  double gyro_scale,accel_scale;
